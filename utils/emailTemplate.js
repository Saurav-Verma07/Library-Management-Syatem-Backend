export function generateVerificationOtpEmailTemplate(otpCode) {
    return `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000000ff; color: #fff;">
    <h2 style="color: #fff; text-align: center;">Verify Your Email Address</h2>
    <p style="font-size: 16px; color: #ccc;">Dear User,</p>
    <p style="font-size: 16px; color: #ccc;">To complete your registration on login, please use the following verification code:</p>
    ...
    <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
        <p>Thank you,<br>Team Library Management System</p>
...
export function generateFogotPasswordEmailTemplate(resetPasswordUrl){
  return `<!-- ----------------------------- FORGOT PASSWORD EMAIL TEMPLATE ----------------------------- -->

<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #000000; color: #fff;">
    ...
    <p style="font-size: 15px; color: #fff; word-wrap: break-word;">${resetPasswordUrl}</p>
